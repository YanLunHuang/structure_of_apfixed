...
module AESL_axi_s_input_1_V_data_27_V (
    input clk,
    input reset,
    output [16 - 1:0] TRAN_input_1_V_data_27_V_TDATA,
    ...
    reg [16 - 1:0] input_1_V_data_27_V_TDATA_write_data;
    reg input_1_V_data_27_V_TDATA_read_en;
    wire [16 - 1:0] input_1_V_data_27_V_TDATA_read_data;
    
    fifo #(9, 16) fifo_input_1_V_data_27_V_TDATA (
        .reset(1'b0),
        .write_clock(clk),
